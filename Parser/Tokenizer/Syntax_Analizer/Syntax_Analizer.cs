    ...
    namespace Syntax_Analizer
    {
        public partial class Syntax
        {
            ...
            public void Start()
            {
                ...
                {
                    if(Error.diagnostics.Count != 0) break;
            ...
            private void Eat(TokenType Type, string argument = "")
            {
                ...
                {
                    if (argument == "")
                        new Error(ErrorKind.Semantic, $"Unexpected type {actual_token.Type} in token {actual_token.Value}; expected type: {Type}", actual_token.actualLine);
                    else
                        new Error(ErrorKind.Semantic, argument + '\n' + $"Unexpected type {actual_token.Type} in token {actual_token.Value}; expected type: {Type}", actual_token.actualLine);
                }
            }
